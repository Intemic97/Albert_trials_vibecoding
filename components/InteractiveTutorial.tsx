...
const TUTORIAL_STEPS: TutorialStep[] = [
    ...
    },
    {
        id: 'sidebar',
        title: 'Navigation',
        description: 'The sidebar organizes features into three areas: Build (create workflows & connect data), Analyze (dashboards & insights), and Reports.',
    ...
    // BUILD SECTION
    {
        ...
        description: 'The core of Intemic. Create automated data pipelines with our visual editor.',
    ...
    },
    {
        ...
        description: 'All your workflows in one place. Start from templates or create custom pipelines.',
    ...
    },
    {
        ...
        description: 'Click to open the visual editor and build your first automated pipeline.',
    ...
    },
    {
        ...
        description: 'Drag nodes from the left panel onto the canvas. Connect them to build automation flows.',
    ...
    },
    {
        ...
        description: 'Define your data structure — entities, properties, and relationships.',
    ...
    },
    {
        ...
        description: 'Create entities like Customers, Products, or Assets with custom properties. These power your workflows and dashboards.',
    ...
    },
    {
        ...
        description: 'Connect to external data sources — databases, APIs, cloud services, and industrial systems.',
        targetSelector: '[data-tutorial="nav-connections"]',
        route: '/database',
        position: 'right',
        action: 'click',
        icon: Lightning,
    ...
    {
        id: 'dashboards-nav',
        title: 'Analyze: Dashboards',
        description: 'Create custom analytics dashboards with charts, tables, and KPIs.',
    ...
    },
    {
        ...
        description: 'Create interactive dashboards. Describe what you want to see — AI generates the visualization.',
    ...
    {
        id: 'copilots-nav',
        title: 'Analyze: Copilots',
        description: 'AI assistants that understand your data and answer questions.',
        targetSelector: '[data-tutorial="nav-copilots"]',
        route: '/dashboard',
        position: 'right',
        action: 'click',
        icon: Sparkle,
    ...
    // REPORTS SECTION
    {
        id: 'reports-nav',
        title: 'Reports',
        description: 'Generate professional documents from templates with your data.',
        targetSelector: '[data-tutorial="nav-templates"]',
        route: '/copilots',
        position: 'right',
        action: 'click',
        icon: FileText,
