                        ...
                        <div className="space-y-6">
                            <div className="flex items-center justify-between">
                                ...
                                <button
                                    ...
                                    className="flex items-center px-3 py-2 bg-[rgb(91,121,128)] hover:bg-[#1e554f] text-white rounded-lg text-sm font-medium transition-colors"
                                >
                            ...
                            <div className="bg-white rounded-lg border border-slate-200 p-6">
                                <div className="flex justify-between items-center mb-6">
                                    ...
                                    <button
                                        ...
                                        className="px-3 py-2 bg-[rgb(91,121,128)] text-white rounded-lg font-medium hover:bg-[#1e554f] transition-colors disabled:opacity-50 flex items-center gap-2"
                                    >
                                        {isSavingCompany ? (
                                            <>
                                            ...
                                            {slackConnected ? (
                                                ...
                                                <div className="mt-4 space-y-4">
                                                    ...
                                                    <button
                                                        ...
                                                        className="flex items-center gap-2 px-3 py-2 bg-[rgb(91,121,128)] hover:bg-[#1e554f] text-white rounded-lg text-sm font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                                                    >
                                                        {isConnectingSlack ? (
                                                            <>
                        ...
                        <div className="bg-white rounded-lg border border-slate-200 shadow-xl w-full max-w-md overflow-hidden">
                            ...
                            <form onSubmit={handleInvite} className="p-6">
                                ...
                                <div className="flex justify-end gap-3 mt-6">
                                    ...
                                    <button
                                        type="submit"
                                        className="px-3 py-2 bg-[rgb(91,121,128)] hover:bg-[#1e554f] text-white rounded-lg text-sm font-medium transition-colors"
                                    >
                                        Send Invitation
                                    </button>
                                </div>
