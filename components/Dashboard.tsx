    ...
    const handleCreateProcessExampleDashboard = async (
        ...
        try {
            ...
            if (createdEntitiesCount > 0) {
                try {
                    const createdEntityIds = [extrusionEntity, productionEntity, rawMaterialEntity, ordersEntity]
                        .filter(Boolean)
                        .map((e: any) => e.id);
                    ...
                    if (!examplesFolder) {
                        ...
                        const createFolderRes = await fetch(`${API_BASE}/knowledge/folders`, {
                            ...
                            body: JSON.stringify({
                                ...
                                description: 'Example entities created from dashboard presets',
                                color: '#f59e0b',
                        ...
                        // Add new entity IDs to existing folder
                        ...
                        <div className="max-w-7xl mx-auto space-y-6" id="dashboard-container">
                            ...
                            {selectedDashboard && (
                                <button
                                    ...
                                    className="fixed bottom-8 right-8 bg-[var(--accent-primary)] text-white rounded-2xl px-5 py-3.5 shadow-xl hover:shadow-2xl hover:bg-[var(--accent-primary-hover)] transition-all duration-300 z-50 flex items-center gap-3 group hover:scale-105 active:scale-95"
                                    title="Add Widget"
                                >
                ...
                >
                    ...
                    >
                        ...
                        <div className="border-t border-[var(--border-light)] p-5 shrink-0 flex items-center justify-between gap-3">
                            ...
                            <button
                                onClick={() => setShowShareModal(false)}
                                className="px-4 py-2.5 bg-[var(--accent-primary)] hover:bg-[var(--accent-primary-hover)] text-white rounded-lg text-sm font-medium transition-all shadow-sm hover:shadow-md"
                            >
                                Done
                            </button>
                        </div>
